...
! function(e, t) {
  ...
  e.fn.extend({
      ...
      revModal: function(a, r) {
          if (a !== t && i[a] !== t) switch (r.mode) {
              case "show":
                  ...
                  break;
              case "close":
                  P(a), document.body.style.overflow = window.overscrollhistory, i[a].modal.bodyclass !== t && i[a].modal.bodyclass.length >= 0 && document.body.classList.remove(i[a].modal.bodyclass), punchgs.TweenMax.to(i[a].modal.bg, 2, {
                      display: "none",
                      opacity: 0,
                      ease: punchgs.Power3.easeInOut
      ...
      getComingSlide: function(a, r) {
          ...
          if (s = 0, i[a].pr_active_slide !== t && i[a].pr_active_slide.hasClass("not-in-nav") && (o = i[a].pr_lastshown_key), r !== t && e.isNumeric(r) || r !== t && r.match(/to/g)) s = 1 === r || -1 === r ? parseInt(o, 0) + r < 0 ? i[a].slideamount - 1 : parseInt(o, 0) + r >= i[a].slideamount ? 0 : parseInt(o, 0) + r : (r = e.isNumeric(r) ? r : parseInt(r.split("to")[1], 0)) < 0 ? 0 : r > i[a].slideamount - 1 ? i[a].slideamount - 1 : r;
              ...
              for (var n in i[a].slides) i[a].slides.hasOwnProperty(n) && (s = i[a].slides && i[a].slides[n] && i[a].slides[n].dataset && i[a].slides[n].dataset.key === r ? n : s);
          return {
              nindex: s,
              aindex: o
          }
      ...
      callingNewSlide: function(e, t, a) {
          ...
          i[e].pr_next_key = r.nindex, i[e].sdir = i[e].pr_next_key < i[e].pr_active_key ? 1 : 0, i[e].c.trigger("revolution.nextslide.waiting"), (r.aindex === i[e].pr_next_key && r.aindex === i[e].pr_lastshown_key || i[e].pr_next_key !== r.aindex && -1 != i[e].pr_next_key) && C(e, a)
      },
      ...
      enterInViewPort: function(a) {
          i[a].waitForCountDown && (Q(a), i[a].waitForCountDown = !1), i[a].waitForFirstSlide && (C(a), i[a].waitForFirstSlide = !1, setTimeout(function() {
  ...
  var a = i.is_mobile(),
      ...
      c = function(r) {
          ...
          for (var d in l) l.hasOwnProperty(d) && (l[d].dataset !== t && "on" == l[d].dataset.hsom && a ? l[d].classList.add("removeslidenow") : (l[d].dataset === t || !l[d].dataset.invisible && 1 != l[d].dataset.invisible ? i[r].slideamount++ : l[d].classList.add("not-in-nav"), i[r].realslideamount++, l[d].dataset !== t && (l[d].dataset.originalindex = i[r].realslideamount, l[d].dataset.origindex = i[r].realslideamount - 1)));
          i[r].canvas.find(".removeslidenow").each(function() {
              ...
              visibility: "visible"
          }), i[r].slayers = i[r].c.find("rs-static-layers"), i[r].slayers.length > 0 && (i[r].slayers[0].dataset.key = "staticlayers"), !0 === i[r].modal.useAsModal && (i[r].cpar.wrap('<rs-modal id="' + i[r].c[0].id + '_modal"></rs-modal>'), i[r].modal.c = i[r].cpar.closest("rs-modal"), i[r].modal.c.appendTo(e("body")), i[r].modal !== t && i[r].modal.alias !== t && i.revModal(r, {
              mode: "init"
      ...
      h = function(r) {
          if (i[r] !== t) {
              ...
              for (var n in i[r].slides = i[r].canvas[0].getElementsByTagName("rs-slide"), i[r].thumbs = new Array(i[r].slides.length), i[r].slots = 4, i[r].firststart = 1, i[r].loadqueue = [], i[r].syncload = 0, i.updateDimensions(r), i[r].slides)
                  if (i[r].slides.hasOwnProperty(n)) {
                      ...
                      d.dataset.title = d.dataset.title === t ? "" : d.dataset.title, d.dataset.description = d.dataset.description === t ? "" : d.dataset.description, h.params[0] = {
                          from: RegExp("\\{\\{title\\}\\}", "g"),
                          to: d.dataset.title
                      }, h.params[1] = {
                      ...
                      for (var v = 1; v <= 10; v++) d.dataset["p" + v] !== t ? h.params[v + 1] = {
                  ...
                  x = x === t || "" === x ? "" : "margin-top:" + x + ";", k = k === t || "" === k ? "" : "margin-bottom:" + k + ";", i[r].topc = e('<rs-fullwidth-wrap id="' + i[r].c[0].id + '_forcefullwidth" style="' + x + k + '"></rs-fullwidth-wrap>'), i[r].forcer = e('<rs-fw-forcer style="height:' + i[r].cpar.height() + 'px"></rs-fw-forcer>'), i[r].topc.append(i[r].forcer), i[r].topc.insertBefore(i[r].cpar), i[r].cpar.detach(), i[r].cpar.css({
                      marginTop: "0px",
                      marginBottom: "0px",
                      position: "absolute"
              ...
              if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && i[r].c.css({
                  ...
                  }), i[r].c.prependTo(i[r].cpar), i[r].c[0].addEventListener("mouseenter", function() {
                  ...
                  }), "standard" !== i[r].sliderType && (i[r].lazyType = "all"), i[r].rs_static_layer = i[r].c[0].getElementsByTagName("rs-static-layers"), i[r].rs_static_layer.length > 0 && (I(i[r].rs_static_layer[0], r, 0, !0), S(i[r].rs_static_layer[0], r, function() {
                  ...
                  if (isNaN(R) || R < 6) i[r].loader = e('<rs-loader class="' + i[r].spinner + '"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></rs-loader>');
                  else {
                      var M, O = i[r].spinnerclr || "#ffffff",
                          P = '<div class="rs-spinner-inner"';
                      if (7 === R) - 1 !== O.search("#") ? (M = O.replace("#", ""), M = "rgba(" + parseInt(M.substring(0, 2), 16) + ", " + parseInt(M.substring(2, 4), 16) + ", " + parseInt(M.substring(4, 6), 16) + ", ") : -1 !== O.search("rgb") && (M = O.substring(O.indexOf("(") + 1, O.lastIndexOf(")")).split(",")).length > 2 && (M = "rgba(" + M[0].trim() + ", " + M[1].trim() + ", " + M[2].trim() + ", "), M && "string" == typeof M && (P += ' style="border-top-color: ' + M + "0.65); border-bottom-color: " + M + "0.15); border-left-color: " + M + "0.65); border-right-color: " + M + '0.15)"');
                  ...
                  i[r].c.append(i[r].loader), 0 === i[r].c.find("rs-progress").length && i[r].c.append('<rs-progress style="visibility:hidden"></rs-progress>'), i[r].c.find("rs-progress").css({
                      width: "0%"
                  }), i[r].canvas.css({
                      display: "block"
                  ...
                  var H = i[r].viewPort;
                  i[r].inviewport = !1, H != t && H.enable && i.scrollTicker && i.scrollTicker(r), i[r].slides.each(function(t) {
                      var a = e(this);
                      ...
                      }), ((H.enable && i[r].inviewport || !H.enable) && "all" == i[r].lazyType || "smart" == i[r].lazyType && (0 == t || 1 == t || t == i[r].slideamount || t == i[r].slideamount - 1)) && (I(a[0], r, t), S(a[0], r, function() {}))
                      ...
                      !H.enable || H.enable && i[r].inviewport || H.enable && !i[r].inviewport && "wait" !== H.outof ? C(r) : (i[r].c.addClass("tp-waitforfirststart"), i[r].waitForFirstSlide = !0, H.presize && (i[r].pr_next_slide = e(i[r].slides[0]), I(i[r].pr_next_slide[0], r, 0, !0), S(i[r].pr_next_slide.find(".tp-layers"), r, function() {
                          i.animateTheLayers && i.animateTheLayers({
                              slide: i[r].pr_next_key,
                              id: r,
                              mode: "preset"
                          })
                      }))), i.manageNavigation && i[r].navigation.use && i.manageNavigation(r), i[r].slideamount > 1 && (!H.enable || H.enable && i[r].inviewport ? Q(r) : i[r].waitForCountDown = !0), setTimeout(function() {
                  ...
                  }), f(r), g(r), i[r].fallbacks.disableFocusListener || "true" == i[r].fallbacks.disableFocusListener || !0 === i[r].fallbacks.disableFocusListener || (i[r].c.addClass("rev_redraw_on_blurfocus"), D())
              }
          }
      },
      g = function(a) {
      ...
      f = function(a, r) {
          e(window).width() < i[a].hideSliderAtLimit ? (i[a].c.trigger("stoptimer"), i[a].cpar[0].dataset.displaycache = "none" != i[a].cpar.css("display") ? i[a].cpar.css("display") : i[a].cpar[0].dataset.displaycache, i[a].cpar.css({
              display: "none"
      ...
      m = function(a) {
          if (i[a].c === t) return !1;
          i[a].c.trigger("revolution.slide.beforeredraw"), 1 == i[a].infullscreenmode && (i[a].minHeight = e(window).height()), l(a), i.resizeThumbsTabs && !0 !== i.resizeThumbsTabs(a) || (f(a, !0), g(a), "carousel" == i[a].sliderType && i.prepareCarousel(a, !0), i.setSize(a), i.updateDimensions(a), "standard" === i[a].sliderType && i[a].mtl !== t && i.animateSlide({
              recall: !0,
              id: a
          }), "carousel" === i[a].sliderType && i[a].lastconw != i[a].conw && (clearTimeout(i[a].pcartimer), i[a].pcartimer = setTimeout(function() {
              i.prepareCarousel(a, !0), "carousel" == i[a].sliderType && i[a].carousel.showLayersAllTime && e.each(i[a].slides, function(e) {
                  i.animateTheLayers && i.animateTheLayers({
                      slide: e,
                      id: a,
                      mode: "rebuild"
          ...
          }, 100), i[a].lastconw = i[a].conw), i.animateTheLayers && (i[a].pr_processing_key !== t ? i.animateTheLayers({
              ...
              id: a,
              mode: "rebuild"
          }), i.scrollHandling && i.scrollHandling(a, !0)), v(a, i[a].pr_next_bg), "carousel" !== i[a].sliderType && v(a, i[a].pr_active_bg), i.manageNavigation && i.manageNavigation(a)), i[a].c.trigger("revolution.slide.afterdraw"), setTimeout(function() {
              g(a)
          }, 19)
      },
      v = function(e, a) {
      ...
      b = function(a) {
          i[a].autoHeight && punchgs.TweenMax.set([i[a].c, i[a].cpar], {
              ...
              overflow: "visible"
          }).wrap("<rs-carousel-wrap></rs-carousel-wrap>"), i[a].cpar.prepend("<rs-carousel-space></rs-carousel-space>").append("<rs-carousel-space></rs-carousel-space>"), i.prepareCarousel(a)), i[a].startWithSlide = i[a].startWithSlide === t ? t : parseInt(i[a].startWithSlide) + 1, i[a].cpar.css({
              overflow: "visible"
          ...
          for (var r = 0; r < i[a].slides.length; r++) {
              var o = e(i[a].slides[r]),
                  s = o.find(">img"),
                  n = o.find("rs-bgvideo");
              s.detach(), n.detach(), (i[a].startWithSlide != t && i[a].slides[r].dataset.originalindex == i[a].startWithSlide || i[a].startWithSlide === t && 0 == r) && (i[a].pr_next_key = o.index()), punchgs.TweenMax.set(o, {
                  width: "100%",
                  height: "100%",
                  overflow: "hidden"
              ...
              c.src = s[0].src, c.lazyload = u(s[0], t, a), c.slidebgimage = !0, d = "none" === d || d === t ? "" : d, n.length > 0 && (n.addClass("defaultvid").css({
                  zIndex: 30
              }), n.appendTo(l), c.parallax != t && (n.data("parallax", c.parallax), n.data("showcoveronpause", "on"))), "none" != i[a].dottedOverlay && i[a].dottedOverlay != t && l.append('<rs-dotted class="' + i[a].dottedOverlay + '"></rs-dotted>'), h += (p ? "" : "background-repeat:" + c.bgrepeat + ";background-image:url(" + c.src + ");background-size:" + c.bgfit + ";background-position:" + c.bgposition + ";") + "width:100%;height:100%;", h += "standard" === i[a].sliderType || "undefined" === i[a].sliderType ? "opacity:0;" : "", s.data("mediafilter", d), d = s.data("panzoom") !== t ? "" : d;
              ...
              for (var y in v)
                  ...
                  } o[0].dataset.scrollBased = !!i[a].sbtimeline.set && (m.s !== t && m.s), i[a].scrolleffect.set ? (i[a].scrolleffect.bgs.push({
                  ...
                  if (l.hasOwnProperty(d) && !(l[d].className.indexOf("rs-pzimg") >= 0)) {
                      ...
                      if (c.loaded === t && g !== t && g.progress && "loaded" == g.progress) {
                          if (l[d].src = g.src, "img" == g.type) {
                              if (c.slidebgimage) {
                                  -1 == g.src.indexOf("images/transparent.png") && -1 == g.src.indexOf("assets/transparent.png") || c.bgcolor === t ? l[d].style.backgroundImage = 'url("' + g.src + '")' : c.bgcolor !== t && (l[d].style.background = c.bgcolor), r.dataset.owidth = g.width, r.dataset.oheight = g.height;
                      ...
                      g && g.progress && g.progress.match(/inprogress|inload|prepared/g) && (!g.error && e.now() - g.starttoload < 3e3 ? n = !0 : (g.progress = "failed", g.reported_img || (g.reported_img = !0, console.log(h + "  Could not be loaded !")))), 1 != i[o].youtubeapineeded || window.YT && YT.Player != t || (n = O("youtube", o)), 1 != i[o].vimeoapineeded || window.Vimeo || (n = O("vimeo", o))
      ...
      C = function(a, r) {
          if (i[a] !== t)
              if (clearTimeout(i[a].waitWithSwapSlide), i[a].pr_processing_key === t) {
                  ...
                  !0 === i[a].onlyPreparedSlide && (i[a].onlyPreparedSlide = !1), i[a].pr_processing_key = i[a].pr_next_key, delete i[a].pr_next_key, i[a].pr_next_slide !== t && i[a].pr_next_slide[0] !== t && i[a].pr_next_slide[0].dataset.hal !== t && (i[a].pr_next_slide[0].dataset.sofacounter = i[a].pr_next_slide[0].dataset.sofacounter == t ? 1 : parseInt(i[a].pr_next_slide[0].dataset.sofacounter, 0) + 1), i[a].stopLoop && i[a].pr_processing_key == i[a].lastslidetoshow - 1 && (i[a].c.find("rs-progress").css({
                      visibility: "hidden"
      ...
      j = function(a, r, o) {
          if (i[r] !== t) {
              if (i[r].pr_active_slide = e(i[r].slides[i[r].pr_active_key]), i[r].pr_next_slide = e(i[r].slides[i[r].pr_processing_key]), i[r].pr_active_bg = i[r].pr_active_slide.find("rs-sbg-wrap"), i[r].pr_next_bg = i[r].pr_next_slide.find("rs-sbg-wrap"), i[r].tonpause = !1, clearTimeout(i[r].loadertimer), i[r].loader !== t && i[r].loader.css({
                  ...
                  }), i[r].transition = 1, i[r].videoplaying = !1, i[r].pr_next_slide[0] !== t && i[r].pr_next_slide[0].dataset.duration != t && "" != i[r].pr_next_slide[0].dataset.duration ? i[r].duration = parseInt(i[r].pr_next_slide[0].dataset.duration, 0) : i[r].duration = i[r].origcd, i[r].pr_next_slide[0] === t || "true" != i[r].pr_next_slide[0].dataset.ssop && !0 !== i[r].pr_next_slide[0].dataset.ssop ? i[r].ssop = !1 : i[r].ssop = !0, i[r].sbtimeline.set && i[r].sbtimeline.fixed && i.updateFixedScrollTimes(r), i[r].c.trigger("nulltimer"), i[r].sdir = i[r].pr_processing_key < i[r].pr_active_key ? 1 : 0, "arrow" == i[r].sc_indicator && (0 == i[r].pr_active_key && i[r].pr_processing_key == i[r].slideamount - 1 && (i[r].sdir = 1), i[r].pr_active_key == i[r].slideamount - 1 && 0 == i[r].pr_processing_key && (i[r].sdir = 0)), i[r].lsdir = i[r].sdir, i[r].pr_active_key != i[r].pr_processing_key && 1 != i[r].firststart && "carousel" !== i[r].sliderType && i.removeTheLayers && i.removeTheLayers(i[r].pr_active_slide, r), i[r].pr_next_slide.hasClass("rs-pause-timer-once") || i[r].pr_next_slide.hasClass("rs-pause-timer-always") ? i[r].videoplaying = !0 : i[r].c.trigger("restarttimer"), i[r].pr_next_slide.removeClass("rs-pause-timer-once"), "carousel" == i[r].sliderType) i[r].mtl = new punchgs.TimelineLite, i.prepareCarousel(r, i[r].mtl), A(r), i[r].transition = 0;
              else {
                  i[r].mtl = new punchgs.TimelineLite({
                      ...
                      autoAlpha: 0,
                      zIndex: 20
                  }), "prepared" == i[r].pr_next_slide[0].dataset.differentissplayed && (i[r].pr_next_slide[0].dataset.differentissplayed = "done", i[r].pr_next_slide[0].dataset.anim = i[r].pr_next_slide[0].dataset.savedanim), i[r].pr_next_slide[0].dataset.firstanim != t && "done" != i[r].pr_next_slide[0].dataset.differentissplayed && (i[r].pr_next_slide[0].dataset.savedanim = i[r].pr_next_slide[0].dataset.anim, i[r].pr_next_slide[0].dataset.anim = i[r].pr_next_slide[0].dataset.firstanim, i[r].pr_next_slide[0].dataset.differentissplayed = "prepared");
                  var s = function(e) {
                  ...
                  i[r].pr_next_slide[0].dataset.ntrid = "on" == i[r].pr_next_slide[0].dataset.rndtrans ? Math.round(80 * Math.random()) : parseInt(i[r].pr_next_slide[0].dataset.ntrid, 0) + 1 || 0, i[r].pr_next_slide[0].dataset.ntrid = s.transition === t || i[r].pr_next_slide[0].dataset.ntrid == s.transition.length ? 0 : i[r].pr_next_slide[0].dataset.ntrid, i.animateSlide({
                      animation: s,
  ...
  var A = function(r) {
          if (i[r] !== t && (i[r].firstSlideAvailable === t && (i[r].firstSlideAvailable = !0, i.showFirstTime !== t && i.showFirstTime(r)), "carousel" === i[r].sliderType || (punchgs.TweenMax.to(i[r].pr_next_bg.find("rs-sbg"), .001, {
              ...
              }(r), i[r].c.find(".active-revslide").removeClass("active-rs-slide"), e(i[r].slides[i[r].pr_active_key]).addClass("active-rs-slide"), i[r].pr_active_bg.data("pztl") != t && (i[r].pr_active_bg.data("pztl").reverse(), i[r].pr_active_bg.data("pztl").timeScale(25)), i[r].pr_next_bg.data("panzoom") !== t && (i[r].pr_next_bg.data("pztl") != t ? (i[r].pr_next_bg.data("pztl").timeScale(1), i[r].pr_next_bg.data("pztl").play()) : i.startPanZoom(i[r].pr_next_bg, r)), i[r].pr_next_slide.find("rs-bgvideo").each(function(t) {
              ...
              if (i[r].c.trigger("revolution.slide.onchange", o), i[r].c.trigger("revolution.slide.onafterswap", o), i[r].pr_lastshown_key = i[r].pr_active_key, i[r].startWithSlide !== t && "done" !== i[r].startWithSlide && "carousel" === i[r].sliderType) {
                  for (var s = i[r].startWithSlide, n = 0; n <= i[r].slides.length - 1; n++) i[r].slides[n] !== t && i[r].slides[n][0] !== t && i[r].slides[n][0].dataset !== t && i[r].slides[n][0].dataset.originalindex === i[r].startWithSlide && (s = n);
                  0 !== s && i.callingNewSlide(r, s), i[r].startWithSlide = "done"
              }
              i[r].duringslidechange = !1, i[r].pr_active_slide.length > 0 && i[r].pr_active_slide[0].dataset.hal != t && 0 != i[r].pr_active_slide[0].dataset.hal && i[r].pr_active_slide[0].dataset.hal <= i[r].pr_active_slide[0].dataset.sofacounter && i[r].c.revremoveslide(i[r].pr_active_slide.index());
      ...
      Y = function(i) {
          return function(i) {
              for (var a in i.minHeight = i.minHeight !== t ? "none" === i.minHeight || "0" === i.minHeight || "0px" === i.minHeight || "" == i.minHeight || " " == i.minHeight ? 0 : parseInt(i.minHeight, 0) : 0, i.maxHeight = "none" === i.maxHeight || "0" === i.maxHeight ? 0 : parseInt(i.maxHeight, 0), i.carousel.maxVisibleItems = i.carousel.maxVisibleItems < 1 ? 999 : i.carousel.maxVisibleItems, i.carousel.vertical_align = "top" === i.carousel.vertical_align ? "0%" : "bottom" === i.carousel.vertical_align ? "100%" : "50%", i.carousel.space = parseInt(i.carousel.space, 0), i.carousel.maxOpacity = parseInt(i.carousel.maxOpacity, 0), i.carousel.maxRotation = parseInt(i.carousel.maxRotation, 0), i.carousel.minScale = parseInt(i.carousel.minScale, 0), i.navigation.maintypes = ["arrows", "tabs", "thumbnails", "bullets"], i.navigation.maintypes) i.navigation.maintypes.hasOwnProperty(a) && i.navigation[i.navigation.maintypes[a]] !== t && (i.navigation[i.navigation.maintypes[a]].animDelay = parseInt(i.navigation[i.navigation.maintypes[a]].animDelay, 0) / 1e3, i.navigation[i.navigation.maintypes[a]].animSpeed = parseInt(i.navigation[i.navigation.maintypes[a]].animSpeed, 0) / 1e3);
      ...
      for (var ei in actions = actions.split("||"), layer.addClass("rs-waction"), _L.events = _L.events === undefined ? [] : _L.events, actions)
          ...
          if ("none" !== t && t !== undefined) {
              if ((t = _R[id].slides[t].dataset.key) !== undefined && _R[id].layers[t])
                  for (e in _R[id].layers[t]) _R[id].layers[t][e].className.indexOf("rs-on-sh") >= 0 && _R.renderLayerAnimation({
                      layer: jQuery(_R[id].layers[t][e]),
                      frame: "frame_1",
                      mode: "trigger",
                      id: id
                  });
              for (e in _R[id].layers.static) _R[id].layers.static[e].className.indexOf("rs-on-sh") >= 0 && _R.renderLayerAnimation({
...
function(e) {
  ...
  jQuery.extend(!0, t, {
      ...
      carouselToEvalPosition: function(e, i) {
          ...
          var s = "center" === o.horizontal_align ? (o.wrapwidth / 2 - o.slide_width / 2 - o.slide_globaloffset) / o.slide_width : (0 - o.slide_globaloffset) / o.slide_width,
              ...
              c = -1 * (Math.ceil(n) - n),
              p = -1 * (Math.floor(n) - n);
          d = l >= .3 && "left" === i || l >= .7 && "right" === i ? c : l < .3 && "left" === i || l < .7 && "right" === i ? p : d, d = o.infinity ? d : n < 0 ? n : s > t[e].slideamount - 1 ? s - (t[e].slideamount - 1) : d, o.slide_offset_target = d * o.slide_width, 0 !== Math.abs(o.slide_offset_target) ? r(e, i, !0) : t.organiseCarousel(e, i)
      },
      organiseCarousel: function(e, i, a, r) {
          ...
          t[e].slides && jQuery.each(t[e].slides, function(r, l) {
              var d = s[r],
                  u = {};
              o.infinity && (d = (d = d > o.wrapwidth - o.inneroffset + o.slide_width && "left" === i ? s[0] - (n - r) * o.slide_width : d) < 0 - o.inneroffset - 3 * o.slide_width ? "left" == i ? d + o.maxwidth : "right" === i ? s[n - 1] + (r + 1) * o.slide_width : d : d), u.left = d + o.inneroffset;
              ...
              void 0 !== o.minScale && o.minScale > 0 && (o.vary_scale ? u.scale = 1 - Math.abs(o.minScale / 100 / Math.ceil(o.maxVisibleItems / g) * h) : u.scale = h >= 1 || h <= -1 ? 1 - o.minScale / 100 : (100 - o.minScale * Math.abs(h)) / 100, p = h * (u.width - u.width * u.scale) / 2), void 0 !== o.maxRotation && 0 != Math.abs(o.maxRotation) && (o.vary_rotation ? (u.rotationY = Math.abs(o.maxRotation) - Math.abs((1 - Math.abs(1 / Math.ceil(o.maxVisibleItems / g) * h)) * o.maxRotation), u.autoAlpha = Math.abs(u.rotationY) > 90 ? 0 : u.autoAlpha) : u.rotationY = h >= 1 || h <= -1 ? o.maxRotation : Math.abs(h) * o.maxRotation, u.rotationY = h < 0 ? -1 * u.rotationY : u.rotationY), u.x = -1 * o.space * h, u.left = Math.floor(u.left), u.x = Math.floor(u.x), void 0 !== u.scale && (u.x = u.x + p), u.zIndex = Math.round(100 - Math.abs(5 * h)), u.force3D = !0, u.transformStyle = "3D" != t[e].parallax.type && "3d" != t[e].parallax.type ? "flat" : "preserve-3d", punchgs.TweenLite.set(l, u)
  ...
  var i = function(e) {
      ...
      r = function(e, i, r, o) {
          ...
          n.from = 0, n.to = s.slide_offset_target, o = void 0 === o ? s.speed / 1e3 : o, o = r ? .4 : o, void 0 !== s.positionanim && s.positionanim.pause(), s.positionanim = punchgs.TweenLite.to(n, o, {
              from: n.to,
              onUpdate: function() {
  ...
  jQuery.extend(!0, i, {
          ...
          for (var n in i[o]._L = void 0 === i[o]._L ? {} : i[o]._L, i[o].layers[s])
              if (i[o].layers[s].hasOwnProperty(n)) {
                  ...
                  if (void 0 === c.dataset.initialised) {
                      ...
                      g.textalign = u(g.textalign), g.vbility = i.revToResp(g.vbility, i[o].rle, !0), g.hoffset = i.revToResp(g.hoffset, i[o].rle, 0), g.voffset = i.revToResp(g.voffset, i[o].rle, 0), g.x = i.revToResp(g.x, i[o].rle, "l"), g.y = i.revToResp(g.y, i[o].rle, "t"), L(h, 0, o), c.dataset.initialised = !0
                  }
                  ...
                  if (d = "slide" === g.basealign ? 0 : Math.max(0, "fullscreen" == i[o].sliderLayout ? v / 2 - i[o].gridheight[i[o].level] * (i[o].keepBPHeight ? 1 : i[o].bh) / 2 : i[o].autoHeight || null != i[o].minHeight && i[o].minHeight > 0 ? i[o].conh / 2 - i[o].gridheight[i[o].level] * i[o].bh / 2 : d), l = "slide" === g.basealign ? 0 : Math.max(0, l), "slide" !== g.basealign && "carousel" === i[o].sliderType && g._isstatic && void 0 !== i[o].carousel && void 0 !== i[o].carousel.horizontal_align && (l = Math.max(0, "center" === i[o].carousel.horizontal_align ? 0 + (i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw) / 2 : "right" === i[o].carousel.horizontal_align ? i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw : l)), "updateposition" !== e.mode) {
                      if (i[o].debugMode && T(h, l, d, g), 0 == g.vbility[i[o].levelForced] || "f" == g.vbility[i[o].levelForced] || m < i[o].hideLayerAtLimit && "on" == g.layeronlimit || m < i[o].hideAllLayerAtLimit ? g.p[0].classList.add("rs-layer-hidden") : g.p[0].classList.remove("rs-layer-hidden"), g.poster = null == g.poster && void 0 !== g.thumbimage ? g.thumbimage : g.poster, "image" === g.layertype)
                          if ("cover-proportional" === g.img.data("c")) {
                              g.img[0].dataset.owidth = void 0 === g.img[0].dataset.owidth ? g.img[0].width : g.img[0].dataset.owidth, g.img[0].dataset.oheight = void 0 === g.img[0].dataset.oheight ? g.img[0].height : g.img[0].dataset.oheight;
                          ...
                          if (g._incolumn && "100%" === O && "auto" === P && void 0 !== g.ytid) {
                          ...
                          } else -1 != h[0].className.indexOf("rs-fsv") || M ? (l = 0, d = 0, g.x = i.revToResp(0, i[o].rle, 0), g.y = i.revToResp(0, i[o].rle, 0), h.css({
                              width: m,
                              ...
                              width: O,
                              height: P
                          }), (0 == g.html5vid && !M || 1 != g.forcecover && !h.hasClass("rs-fsv") && !M) && (g.media.width(O), g.media.height(P)), g._ingroup && null != O && !jQuery.isNumeric(O) && O.indexOf("%") > 0 && punchgs.TweenMax.set([g.lp, g.p, g.m], {
                              minWidth: O
                          })
                      }
                      g._slidelink || z(h, o, 0, g.rsp_bd), "on" === g.rsp_ch && "row" !== g.type && "column" !== g.type && "group" !== g.type && h.find("*").each(function() {
                          var e = jQuery(this);
      ...
      animcompleted: function(e, t) {
          if (void 0 !== i[t].videos) {
              ...
              null != a && null != a.type && "none" != a.type && (1 == a.aplay || "true" == a.aplay || "on" == a.aplay || "1sttime" == a.aplay ? (("carousel" !== i[t].sliderType || !i[t].carousel.showLayersAllTime && e.closest("rs-slide").index() == i[t].pr_active_key) && i.playVideo(e, t), i.toggleState(e.data("videotoggledby")), (a.aplay1 || "1sttime" == a.aplay) && (a.aplay1 = !1, a.aplay = !1)) : ("no1sttime" == a.aplay && (a.datasetautoplay = "on"), i.unToggleState(e.data("videotoggledby"))))
          }
      },
      handleStaticLayers: function(e, t) {
          ...
          a = Math.max(0, a), r = Math.min(i[t].realslideamount, r < 0 ? i[t].realslideamount : r), r = 1 !== a && 0 !== a || r !== i[t].realslideamount ? r : i[t].realslideamount + 1, e.data("startslide", a), e.data("endslide", r), e[0].dataset.startslide = a, e[0].dataset.endslide = r
      },
      animateTheLayers: function(e) {
          ...
          if (i[t].layers = i[t].layers || {}, i[t].layers[a] = void 0 === i[t].layers[a] ? x(jQuery(i[t].slides[e.slide]), "rs-layer") : i[t].layers[a], i[t].layers.static = void 0 === i[t].layers.static ? x(jQuery(i[t].c.find("rs-static-layers")), "rs-layer") : i[t].layers.static, i[t].sbas[a] = void 0 === i[t].sbas[a] ? x(jQuery(i[t].slides[e.slide]), "rs-sba") : i[t].sbas[a], i.updateDimensions(t), i[t].debugMode && k(t), void 0 !== a && i[t].layers[a] && i.initLayer({
              ...
              }, 200), i[t].dimensionReCheck = !0), (void 0 !== i[t].rowzones && i[t].rowzones.length > 0 && r >= 0 && i[t].rowzones[Math.min(r, i[t].rowzones.length)].length > 0 || void 0 !== i[t].srowzones && i[t].srowzones.length > 0 || void 0 !== i[t].smiddleZones && i[t].smiddleZones.length > 0) && (i.setSize(t), i.updateDimensions(t), i.initLayer({
                  id: t,
                  skey: a,
                  mode: "updateposition"
              }), i.initLayer({
      ...
      renderLayerAnimation: function(e) {
          ...
          if ("preset" !== e.mode || !0 === u.frames.frame_1.timeline.waitoncall || void 0 !== u.scrollBasedOffset || !0 === u.forceRender) {
              ...
              for (var R in "start" === e.mode && void 0 !== u.layerLoop && (u.layerLoop.count = 0), "start" === e.mode && (e.frame = void 0 === u.triggeredFrame ? 0 : u.triggeredFrame), "continue" !== e.mode && "trigger" !== e.mode && void 0 !== u.timeline && u.timeline.pause(0), "continue" !== e.mode && "trigger" !== e.mode || void 0 === u.timeline || u.timeline.pause(), u.timeline = new punchgs.TimelineMax({
                  ...
                  if (u.ford.hasOwnProperty(R)) {
                      ...
                      if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                          if ("frame_999" === I && !u.frames[I].timeline.waitoncall && u.frames[I].timeline.start >= i[c].duration && (u.frames[I].timeline.waitoncall = !0), "start" === e.mode && "keep" !== u.triggercache && (u.frames[I].timeline.callstate = u.frames[I].timeline.waitoncall ? "waiting" : ""), "trigger" === e.mode && u.frames[I].timeline.waitoncall && (I === e.frame ? (u.frames[I].timeline.triggered = !0, u.frames[I].timeline.callstate = "called") : u.frames[I].timeline.triggered = !1), "rebuild" === e.mode || u.frames[I].timeline.triggered || (u.frames[I].timeline.callstate = u.frames[I].timeline.waitoncall ? "waiting" : ""), !1 !== e.fastforward) {
                          ...
                          if (I !== e.frame && u.frames[I].timeline.waitoncall && "called" !== u.frames[I].timeline.callstate && (b = !0), I !== e.frame && w && (b = !0 === b && u.frames[I].timeline.waitoncall ? "skiprest" : !0 !== b && b), b && "waiting" === u.frames[I].timeline.callstate && "preset" === e.mode && 1 != u.firstTimeRendered) z = !0, u.firstTimeRendered = !0;
                          ...
                          if ("frame_999" !== I || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                              u.fff = "frame_1" === I && ("trigger" !== e.mode || "frame_999" === u.currentframe || "frame_0" === u.currentframe || void 0 === u.currentframe), z || (u.frames[I].timeline.callstate = "called", u.currentframe = I);
                              var S = u.frames[I],
                                  ...
                                  B = H.ease;
                              "block" === j.type && (j.ft[0].background = S.sfx.fxc, O.add(punchgs.TweenMax.fromTo(j.bmask_in, A / 2, j.ft[0], j.ft[1], 0)), O.add(punchgs.TweenMax.fromTo(j.bmask_in, A / 2, j.ft[1], j.t, A / 2)), "frame_0" === I || "frame_1" === I ? N.opacity = 0 : "frame_999" === I && O.add(P.staggerFromTo(C, .05, {
                                  autoAlpha: 1
                              }, {
                                  autoAlpha: 0,
                                  delay: A / 2
                              }, 0), .001)), void 0 !== S.color ? H.color = S.color : void 0 !== u.color && "npc" !== u.color[p] && (H.color = u.color[p]), void 0 !== M && void 0 !== M.color ? N.color = M.color : void 0 !== M && void 0 !== u.color && "npc" !== u.color[p] && (N.color = u.color[p]), void 0 !== S.bgcolor ? S.bgcolor.indexOf("gradient") >= 0 ? H.background = S.bgcolor : H.backgroundColor = S.bgcolor : !0 === u.bgcolinuse && (u.bgcol.indexOf("gradient") >= 0 ? H.background = u.bgcol : H.backgroundColor = u.bgcol), void 0 !== M && (void 0 !== M.bgcolor ? M.bgcolor.indexOf("gradient") >= 0 ? N.background = M.bgcolor : N.backgroundColor = M.bgcolor : !0 === u.bgcolinuse && (u.bgcol.indexOf("gradient") >= 0 ? N.background = u.bgcol : N.backgroundColor = u.bgcol));
                              var Y = 0;
                              if (void 0 !== u.splitText && !1 !== u.splitText)
                                  for (var F in t)
                                      if (void 0 === S[t[F]] || u.quickRendering) u.fff ? O.add(P.fromTo(u.splitText[t[F]], A, {
                                          immediateRender: !1,
                                          color: N.color
                                      }, {
                                          color: H.color
                                          ...
                                          Q = void 0 === S[t[F]].delay ? .05 : S[t[F]].delay / 100, X.color = H.color, void 0 !== N && (E.color = N.color);
                                          var Z = v(jQuery.extend(!0, {}, X)),
                                              q = u.fff ? v(jQuery.extend(!0, {}, E)) : void 0;
                                          delete Z.dir, Z.data = {
                                              splitted: !0
                                          }, void 0 !== q && delete q.dir, u.fff ? O.add(P.staggerFromTo(V, A, q, Z, u.frames[I].split ? Q : 0, 0), 0) : O.add(P.staggerTo(V, A, Z, u.frames[I].split ? Q : 0, 0), 0), Y = V.length > Y ? V.length : Y
                                      } A += u.frames[I].split ? Q * Y : 0, u.pxundermask || void 0 !== D && (void 0 !== M && "hidden" === M.mask.overflow || "hidden" === S.mask.overflow) ? (O.add(punchgs.TweenMax.to(u.m, .001, {
                                  overflow: "hidden"
                              }), 0), "column" === u.type && O.add(punchgs.TweenMax.to(u.cbgmask, .001, {
                                  overflow: "hidden"
                              }), 0), u.btrans && (W && (W.rotationX = u.btrans.rX, W.rotationY = u.btrans.rY, W.rotationZ = u.btrans.rZ, W.opacity = u.btrans.o), D.rotationX = u.btrans.rX, D.rotationY = u.btrans.rY, D.rotationZ = u.btrans.rZ, D.opacity = u.btrans.o), u.fff ? O.add(punchgs.TweenMax.fromTo([u.m, u.cbgmask], A, jQuery.extend(!0, {}, W), jQuery.extend(!0, {}, D)), .001) : O.add(punchgs.TweenMax.to([u.m, u.cbgmask], A, jQuery.extend(!0, {}, D)), .001)) : void 0 !== u.btrans ? O.add(punchgs.TweenMax.to(u.m, .001, {
                                  x: 0,
                                  y: 0,
                                  filter: "none",
                                  opacity: u.btrans.o,
                              ...
                              u.timeline.addLabel(I, U), u.timeline.add(O, U), u.timeline.addLabel(I + "_end", "+=0.01"), O.eventCallback("onStart", o, [{
                                  id: c,
                                  frame: I,
                                  L: d
              ...
              if (z || (u.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? e.frame : u.lastRequestedMainFrame), void 0 !== e.totime ? u.tSTART = e.totime : void 0 !== f && void 0 === e.frame ? u.tSTART = f : void 0 !== e.frame ? u.tSTART = e.frame : u.tSTART = 0, "frame_999" !== u.tSTART && "frame_999" !== u.triggeredFrame || !u.leftstage && void 0 !== u.startedAnimOnce) {
  ...
  var a = function(e) {
      ...
      o = function(e) {
          ...
          i[e.id]._L[e.L[0].id].ignoremousemove = !1, i[e.id]._L[e.L[0].id].leftstage = !1, i[e.id]._L[e.L[0].id].readyForHover = !1, r.layer = e.L, void 0 !== i[e.id]._L[e.L[0].id].layerLoop && i[e.id]._L[e.L[0].id].layerLoop.from === e.frame && i[e.id]._L[e.L[0].id].layerLoop.count++, "frame_999" !== e.frame && (i[e.id]._L[e.L[0].id].startedAnimOnce = !0, punchgs.TweenMax.set([i[e.id]._L[e.L[0].id].c, i[e.id]._L[e.L[0].id].l, i[e.id]._L[e.L[0].id].m], {
              ...
              visibility: "visible"
          })), r.eventtype = "frame_0" === e.frame || "frame_1" === e.frame ? "enterstage" : "frame_999" === e.frame ? "leavestage" : "framestarted", r.layertype = i[e.id]._L[e.L[0].id].type, r.frame_index = e.frame, r.layersettings = i[e.id]._L[e.L[0].id], i[e.id].c.trigger("revolution.layeraction", [r]), "enterstage" === r.eventtype && i.toggleState(i[e.id]._L[e.L[0].id].layertoggledby), "frame_1" === e.frame && i.animcompleted(e.L, e.id)
      },
      s = function(e) {
      ...
      k = function(e) {
          ...
          t.addClass("indebugmode"), t.find(".helpgrid").remove(), i[e].c.find(".hglayerinfo").remove(), t.append('<div class="helpgrid" style="width:' + i[e].gridwidth[i[e].level] * i[e].bw + "px;height:" + i[e].gridheight[i[e].level] * i[e].bw + 'px;"></div>');
          var a = t.find(".helpgrid");
          a.append('<div class="hginfo">Zoom:' + Math.round(100 * i[e].bw) + "% &nbsp;&nbsp;&nbsp; Device Level:" + i[e].level + "&nbsp;&nbsp;&nbsp; Grid Preset:" + i[e].gridwidth[i[e].level] + "x" + i[e].gridheight[i[e].level] + "</div>"), i[e].c.append('<div class="hglayerinfo"></div>'), a.append('<div class="tlhg"></div>')
      },
      T = function(e, t, a, r) {
              ...
              if (void 0 !== t[e].pr_next_key || void 0 !== t[e].pr_active_key) {
                  ...
                  if (!0 === o.enable) {
                      ...
                      if (null != t[e].thumbs[l] && jQuery.each(t[e].thumbs[l].params, function(e, t) {
                          ...
                          }), o.left.j.html(c), c = o.tmp, d > t[e].slideamount) return;
                      jQuery.each(t[e].thumbs[d].params, function(e, t) {
                          c = c.replace(t.from, t.to)
                      }), o.right.j.html(c), o.rtl ? (punchgs.TweenLite.set(o.left.j.find(".tp-arr-imgholder"), {
                  ...
                  if ("carousel" === t[a].sliderType && (("move" === s || "end" === s || "cancel" == s) && t[a].dragStartedOverSlider && !t[a].dragStartedOverThumbs && !t[a].dragStartedOverTabs || "start" === s && g > 0 && 0 === f && 0 === m)) {
                      ...
                      switch (s) {
                          ...
                          case "move":
                              ...
                              O = O < P ? "horizontal" === R ? O + L.width() * (O - P) / L.width() * (O - P) / L.width() : O + L.height() * (O - P) / L.height() * (O - P) / L.height() : O, "vertical" === R ? punchgs.TweenLite.set(L, {
                                  top: O + "px"
                          ...
                          case "end":
                          case "cancel":
                              if (v) return O = M + c, O = (O = "vertical" === R ? O < 0 - (L.height() - T.height()) ? 0 - (L.height() - T.height()) : O : O < 0 - (L.width() - T.width()) ? 0 - (L.width() - T.width()) : O) > 0 ? 0 : O, O = Math.abs(c) > S / 10 ? c <= 0 ? Math.floor(O / S) * S : Math.ceil(O / S) * S : c < 0 ? Math.ceil(O / S) * S : Math.floor(O / S) * S, O = (O = "vertical" === R ? O < 0 - (L.height() - T.height()) ? 0 - (L.height() - T.height()) : O : O < 0 - (L.width() - T.width()) ? 0 - (L.width() - T.width()) : O) > 0 ? 0 : O, "vertical" === R ? punchgs.TweenLite.to(L, .5, {
                                  top: O + "px",
                  ...
                  h = function(e, t, i) {
                      var a = void 0 === i.panvalues ? jQuery.extend(!0, {}, function(e) {
                              ...
                              for (var a in t)
                                  ...
                                  } return i.offsetstart = i.offsetstart.split("https://themetechmount.com/") || [0, 0], i.offsetend = i.offsetend.split("https://themetechmount.com/") || [0, 0], i.rotatestart = 0 === i.rotatestart ? .01 : i.rotatestart, e.panvalues = i, e.bgposition = "center center" == e.bgposition ? "50% 50%" : e.bgposition, i
                  ...
                  if (s.find(".tp-parallax-container").each(function(e) {
                      ...
                      "carousel" === t[e].sliderType && (g = "rs-slide .dddwrapper, rs-slide .dddwrapper-layer, rs-static-layers .dddwrapper-layer"), t[e].c.find(g).each(function() {
                          var r = jQuery(this),
                              ...
                              g = 0,
                              f = !1;
                          r.hasClass("dddwrapper-layer") && (g = a.ddd_z_correction || 65, f = !0), r.hasClass("dddwrapper-layer") && (s = 0, n = 0), h.hasClass("active-revslide") || "carousel" != t[e].sliderType ? !a.ddd_bgfreeze || f ? punchgs.TweenLite.to(r, u, {
                              rotationX: d,
                              rotationY: -l,
                              x: s,
                              z: g,
...
function(e) {
  ...
  var i = function(e, t) {
      ...
      a = function(e) {
          ...
          if (u = "default" === u || "d" === u ? s.TR[8] || punchgs.Power2.easeInOut : u || s.TR[8] || punchgs.Power2.easeInOut, h = "default" === h || "d" === h ? s.TR[9] || punchgs.Power2.easeInOut : h || s.TR[9] || punchgs.Power2.easeInOut, 0 == n) {
              var g = Math.ceil(t[a].height / t[a].sloth),
                  f = 0;
              t[a].pr_next_bg.find(".slotslide").each(function(e) {
                  f = ++f === g ? 0 : f, t[a].rotate = 1 === s.trC ? 45 : t[a].rotate, t[a].mtl.add(punchgs.TweenLite.from(this, d / 2e3, {
                      opacity: 0,
                      transformStyle: "flat",
                      transformPerspective: 600,
                      scale: 0,
          ...
          } else if (1 == n) t[a].pr_next_bg.find(".slotslide").each(function(e) {
          ...
          else if (2 == n || 3 == n) t[a].pr_active_bg.find(".slotslide").each(function() {
          ...
          } else if (7 == n || 8 == n) d = Math.min(t[a].duration || d, d), t[a].pr_active_bg.find(".slotslide").each(function(e) {
              ...
              for (var y = t[a].pr_next_bg[0].getElementsByClassName("slotslide"), b = d - d / 1.8, w = 0; w < y.length; w++) t[a].mtl.add(punchgs.TweenLite.fromTo(y[w], (d - w * (b / t[a].slots)) / 1e3, {
                  opacity: 0,
                  force3D: "auto",
                  transformPerspective: 600
              }, {
              ...
              switch (s.trC) {
                  ...
                  case 1:
                      t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 1e3, {
                          ...
                          force3D: "auto",
                          ease: u
                      }), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, {
                          autoAlpha: 1
                      }, {
                          autoAlpha: 0,
                          force3D: "auto",
                  ...
                  case 4:
                      t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_active_bg.parent(), {
                          ...
                          backgroundColor: "transparent",
                          force3D: "auto"
                      }), 0), t[a].mtl.add(punchgs.TweenLite.to(t[a].pr_active_bg, d / 2e3, {
                          autoAlpha: 0,
                          force3D: "auto",
                          ease: u
                      }), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 2e3, {
                          autoAlpha: 0
                      }, {
                          autoAlpha: 1,
                          force3D: "auto",
                  ...
                  case 12:
                      ...
                      t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 1e3, {
                          ...
                          force3D: "auto",
                          ease: u
                      }), 0), jQuery.inArray(s.trC, [6, 8, 10]) >= 0 && t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, {
                          autoAlpha: 1,
                          filter: k,
                          "-webkit-filter": k
                      }, {
              ...
              if (7 != s.trC && 4 != s.trC || (R = 0, I = 0), 8 == s.trC ? (t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_active_slide, {
                      zIndex: 20
                      ...
                      zIndex: 20
                  }), 0), t[a].mtl.add(punchgs.TweenLite.from(t[a].pr_next_bg, T, {
                      left: z,
                      top: S,
                      overflow: "hidden",
                      scale: P,
              ...
              t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_active_slide, {
                  ...
                  t[a].mtl.add(punchgs.TweenLite.fromTo(this, d / 1e3, {
                      ...
                      delay: 0,
                      ease: u
                  }), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(this, d / 2e3, {
                      opacity: 1
                  }, {
                      opacity: 0,
                      delay: d / 2e3
          ...
          } else if (17 == n || 18 == n) t[a].pr_next_bg.find(".slotslide").each(function(e) {
              ...
              punchgs.TweenLite.set(t[a].c, {
              ...
              }), 0), 22 !== n && 24 !== n || t[a].mtl.add(punchgs.TweenLite.fromTo([t[a].pr_active_bg, t[a].pr_next_bg], d / 2e3, {
                  z: -200
              }, {
                  z: 0,
                  ease: "Power2.easeIn",
                  delay: d / 2e3
              }), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 2e3, {
                  z: 0
              }, {
                  z: -200,
                  ease: "Power3.easeInOut",
                  delay: 0,
                  force3D: "auto"
              }), 0), 19 !== n && 23 !== n || t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 2e3, {
                  autoAlpha: 1
              }, {
                  autoAlpha: 0,
              ...
              C = 1 === o ? "20% " : "80% ";
              C += "60% -50%", t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 1e3, {
                  ...
                  delay: 0,
                  ease: u
              }), 0), C = 1 != o ? "20% " : "80% ", C += "60% -50%", t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, {
                  autoAlpha: 1,
                  rotationX: 0,
                  top: 0,
                  z: 0,
              ...
              t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, d / 1e3, {
                  ...
                  rotationY: 0,
                  ease: u
              }), 0), C = 1 === o ? 25 === n ? "center bottom 0" : "right center 0" : 25 === n ? "center top 0" : "left center 0", j = 25 !== n ? -j : j, A = 25 !== n ? A : -A, t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, {
                  rotationX: 0,
                  rotationY: 0,
                  transformStyle: "flat",
                  transformPerspective: 1200,
          ...
          } else if (26 == n) d = 0, t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, .001, {
              autoAlpha: 0
          }, {
              autoAlpha: 1,
              force3D: "auto",
              ...
              Y[G] = "0px", F[G] = H, V[G] = B, X[G] = "0%", E[G] = N, Z[G] = H, q[G] = D, U[G] = W, Q.append('<span style="background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, Y, F), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg.find("rs-sbg"), d / 2e3, V, X), d / 2e3), t[a].mtl.add(punchgs.TweenLite.fromTo(Q, d / 1e3, E, Z), 0), t[a].mtl.add(punchgs.TweenLite.fromTo(Q.find(".slotslide div"), d / 1e3, q, U), 0)
          }
      },
      r = function(e, i, a, r) {
          var o = e.find("rs-sbg"),
...
function(e) {
  ...
  jQuery.extend(!0, t, {
      ...
      resetVideo: function(e, a, r, o) {
          ...
          switch (s.type) {
              case "youtube":
                  ...
                  break;
              case "vimeo":
                  void 0 !== s.vimeoplayer && !o && s.rwd && (0 !== s.ssec && -1 !== s.ssec || s.bgvideo || e.find("rs-poster").length > 0) && (s.ssec >= 0 && s.vimeoplayer.setCurrentTime(s.ssec), s.vimeoplayer.pause()), 0 != e.find("rs-poster").length || s.bgvideo || "preset" === r || punchgs.TweenLite.to(e.find("iframe"), .3, {
                      opacity: 1,
                      display: "block",
                      ease: punchgs.Power3.easeInOut
                  });
              ...
              case "html5":
                  ...
                  punchgs.TweenLite.to(s.jvideo, .3, {
                      ...
                      display: "block",
                      ease: punchgs.Power3.easeInOut
                  }), s.rwd && !e.hasClass("videoisplaying") && (s.video.currentTime = -1 == s.ssec ? 0 : s.ssec), ("mute" == s.volume || t.lastToggleState(e.videomutetoggledby) || !0 === t[a].globalmute) && (s.video.muted = !0)
          }
      },
      Mute: function(e, i, a) {
          var r = !1,
          ...
          switch (o.type) {
              case "youtube":
                  ...
                  break;
              case "vimeo":
                  o.volcachecheck || (o.volcache = o.volcache >= 1 ? o.volcache / 100 : o.volcache, o.volcachecheck = !0), o.volume = !0 === a ? "mute" : !1 === a ? o.volcache : o.volume, void 0 !== a && null != o.vimeoplayer && n(o, !0 === a ? 0 : o.volcache), r = "mute" == o.volume;
                  break;
              case "html5":
          ...
          switch (clearTimeout(a.videoplaywait), a.type) {
              ...
              case "vimeo":
                  0 == e.find("iframe").length ? (delete a.vimeoplayer, e.append(a.videomarkup), u(e, i, !0)) : e.hasClass("rs-apiready") ? (a.vimeoplayer = null == a.vimeoplayer ? new Vimeo.Player(e.find("iframe").attr("id")) : a.vimeoplayer, a.vimeoplayer.getPaused() ? setTimeout(function() {
                      ...
                      a.nseTriggered && (r = -1, a.nseTriggered = !1), -1 != a.ssec && a.ssec > r && a.vimeoplayer.setCurrentTime(a.ssec), ("mute" == a.volume || 0 === a.volume || t.lastToggleState(e.data("videomutetoggledby")) || !0 === t[i].globalmute) && a.vimeoplayer.setVolume(0), d(a.vimeoplayer)
      ...
      prepareCoveredVideo: function(e, i) {
          ...
          if (void 0 === a.vimeoid || void 0 !== a.vimeoplayerloaded) {
              ...
              var r = t[e].conw / t[e].conh,
                  o = r / a.vd * 100,
                  s = a.vd / r * 100;
              "html5" === a.type && "Edge" !== t.get_browser() && "IE" !== t.get_browser() && (s = 100, o = 100), r > a.vd ? punchgs.TweenLite.set(a.ifr, {
                  height: o + "%",
                  width: "100%",
                  top: -(o - 100) / 2 + "%",
                  left: "0px",
      ...
      checkVideoApis: function(e, i) {
          ...
          if (!t[i].vimeoapineeded && ((null != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && (t[i].vimeoapineeded = !0), t[i].vimeoapineeded && !window.rs_addedvim)) {
              ...
              s.src = "../../../player.vimeo.com/api/player.js", jQuery("head").find("*").each(function() {
          ...
          if (i && o.opom) 0 == e.find("rs-poster").length && e.append('<rs-poster class="noSwipe" style="background-image:url(' + o.poster + ');"></rs-poster>');
              ...
              switch (o.id = e[0].id, o.audio = s, o.pload = "auto" === o.pload || "canplay" === o.pload || "canplaythrough" === o.pload || "progress" === o.pload ? "auto" : o.pload, o.loop = !0 === o.nse || "loop" != o.loop && "loopandnoslidestop" != o.loop ? "" : "loop", o.type = null != o.mp4 || null != o.webm ? "html5" : null != o.ytid && String(o.ytid).length > 1 ? "youtube" : null != o.vimeoid && String(o.vimeoid).length > 1 ? "vimeo" : "none", o.newtype = "html5" == o.type && 0 == e.find(o.audio ? "audio" : "video").length ? "html5" : "youtube" == o.type && 0 == e.find("iframe").length ? "youtube" : "vimeo" == o.type && 0 == e.find("iframe").length ? "vimeo" : "none", s || "1sttime" != o.aplay || "loopandnoslidestop" == o.loopcache || e.closest("rs-slide").addClass("rs-pause-timer-once"), s || 1 != o.aplay && "true" != o.aplay && "no1sttime" != o.aplay || "loopandnoslidestop" == o.loopcache || e.closest("rs-slide").addClass("rs-pause-timer-always"), o.noInt && e.addClass("rs-nointeraction"), o.newtype) {
                  case "html5":
                      ...
                      "video" === o.tag && null != o.webm && "firefox" == t.get_browser().toLowerCase() && (l = l + '<source src="' + o.webm + '" type="video/webm" />'), null != o.mp4 && (l = l + '<source src="' + o.mp4 + '" type="' + ("video" === o.tag ? "video/mp4" : "audio/mpeg") + '" />'), null != o.ogv && (l = l + '<source src="' + o.mp4 + '" type="' + o.tag + '/ogg" />'), l += "</" + o.tag + ">", o.videomarkup = l, i && o.notonmobile || t.isIE(8) || e.append(l), e.find(o.tag).parent().hasClass("html5vid") || e.find(o.tag).wrap('<div class="html5vid" style="position:relative;top:0px;left:0px;width:100%;height:100%; overflow:hidden;"></div>'), o.jvideo = e.find(o.tag), o.video = o.jvideo[0], o.html5vid = o.jvideo.parent(), o.metaloaded || r(o.video, "loadedmetadata", function(e) {
                  ...
                  case "youtube":
                      ...
                      var d = o.vatr.split("origin%3dhttps_/index.html");
                      o.vatrnew = d.length > 1 ? d[0] + "origin=https://" + (self.location.href.match(/www/gi) && !d[1].match(/www/gi) ? "www." + d[1] : d[1]) : o.vatr, o.videomarkup = '<iframe allow="autoplay; fullscreen" type="text/html" src="https://www.youtube.com/embed/' + o.ytid + "?" + o.vatrnew + '" ' + (!0 === o.afs ? "allowfullscreen" : "") + ' width="100%" height="100%" style="opacity:0;visibility:visible;width:100%;height:100%"></iframe>';
                      break;
                  case "vimeo":
              ...
              "none" !== o.doverlay && void 0 !== o.doverlay && 1 != e.find("rs-dotted").length && e.append('<rs-dotted class="' + o.doverlay + '"></rs-dotted>'), e[0].dataset.videoLayerManaged = !0, o.bgvideo && punchgs.TweenLite.set(e.find("video, iframe"), {
                  opacity: 0
              })
          }
      }
  ...
  var r = function(e, t, i) {
      ...
      u = function(e, a, r) {
          ...
          if (n.ifr = e.find("iframe"), s(a, e), n.ifr.attr("id", u), n.startvideonow = r, n.videolistenerexist) {
                      ...
                      events: {
                          onStateChange: function(i) {
                              i.data == YT.PlayerState.PLAYING ? (punchgs.TweenLite.to(e.find("rs-poster"), .3, {
                                  ...
                                  opacity: 0,
                                  ease: punchgs.Power3.easeInOut
                              })), -1 != i.data && 3 != i.data && (t[a].videoplaying = !1, t[a].tonpause = !1, b(e, a), t[a].c.trigger("starttimer"), t[a].c.trigger("revolution.slide.onvideostop", o(n.player, "youtube", n)), null != t[a].videoIsPlaying && t[a].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)), 0 == i.data && n.nse ? (h(), n.nseTriggered = !0, t[a].c.revnext(), b(e, a)) : (b(e, a), t[a].videoplaying = !1, t[a].c.trigger("starttimer"), t[a].c.trigger("revolution.slide.onvideostop", o(n.player, "youtube", n)), null != t[a].videoIsPlaying && t[a].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)))
                          },
                          onReady: function(a) {
                              var r, o = t.is_mobile(),
                                  s = e.hasClass("rs-layer-video");
                              !o && (!t.isSafari11() || o && s || "RS-BGVIDEO" !== e[0].tagName && (!s || !n.aplay && "true" !== n.aplay)) || (r = !0, n.player.setVolume(0), n.volume = "mute", n.player.mute(), clearTimeout(e.data("mobilevideotimr")), e.data("mobilevideotimr", setTimeout(function() {
                                  c(n)
                                  ...
                                  i || c(n)
                              }), n.startvideonow && (c(n), -1 != n.ssec && n.player.seekTo(n.ssec)), n.videolistenerexist = !0
                          }
                      }
                  });
                  break;
              case "vimeo":
                  ...
                  if (R && I && (w += "&background=1"), n.ifr.attr("src", w), n.vimeoplayer = void 0 === n.vimeoplayer || !1 === n.vimeoplayer ? new Vimeo.Player(u) : n.vimeoplayer, R) I ? T = !0 : (n.aplay || "true" === n.aplay) && (L && (n.aplay = !1), T = !0), T && (n.vimeoplayer.setVolume(0), n.volume = "mute");
                  n.vimeoplayer.on("play", function(t) {
                      ...
                      n.vimeostarted || p(n, e, a), n.currenttime = i.seconds, 0 != n.esec && Math.abs(n.esec - i.seconds) < 1 && n.esec > i.seconds && !n.nextslidecalled && (f ? (d(n.vimeoplayer), -1 != n.ssec && n.vimeoplayer.setCurrentTime(n.ssec)) : (n.nse && (n.nseTriggered = !0, n.nextslidecalled = !0, t[a].c.revnext()), n.vimeoplayer.pause()))
                  }), n.vimeoplayer.on("ended", function(i) {
                      n.vimeostarted = !1, b(e, a), t[a].videoplaying = !1, t[a].c.trigger("starttimer"), t[a].c.trigger("revolution.slide.onvideostop", o(n.vimeoplayer, "vimeo", n)), n.nse && (n.nseTriggered = !0, t[a].c.revnext()), null != t[a].videoIsPlaying && t[a].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)
                      ...
                      n.vimeostarted = !1, (n.scop && e.find("rs-poster").length > 0 || n.bgvideo && e.find(".rs-fullvideo-cover").length > 0) && (n.bgvideo ? punchgs.TweenLite.to(e.find(".rs-fullvideo-cover"), .1, {
                          ...
                          opacity: 0,
                          ease: punchgs.Power3.easeInOut
                      })), t[a].videoplaying = !1, t[a].tonpause = !1, b(e, a), t[a].c.trigger("starttimer"), t[a].c.trigger("revolution.slide.onvideostop", o(n.vimeoplayer, "vimeo", n)), null != t[a].videoIsPlaying && t[a].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)
      ...
      f = function(e, a, s) {
          ...
          n.metaloaded = !0, n.control || (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), e.find("video, rs-poster, .tp-video-play-button").click(function() {
              ...
              !g() && e.find("rs-poster").length > 0 && n.scop && (punchgs.TweenLite.to(e.find("rs-poster"), .3, {
                  ...
                  opacity: 0,
                  ease: punchgs.Power3.easeInOut
              })), e.removeClass("videoisplaying"), t[a].videoplaying = !1, b(e, a), "audio" != n.tag && t[a].c.trigger("starttimer"), t[a].c.trigger("revolution.slide.onvideostop", o(n.video, "html5", n)), null != t[a].videoIsPlaying && t[a].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)
          }), r(n.video, "ended", function() {
              h(), b(e, a), t[a].videoplaying = !1, b(e, a), "audio" != n.tag && t[a].c.trigger("starttimer"), t[a].c.trigger("revolution.slide.onvideostop", o(n.video, "html5", e.data())), n.nse && n.video.currentTime > 0 && (1 == !t[a].jcnah && (n.nseTriggered = !0, t[a].c.revnext(), t[a].jcnah = !0), setTimeout(function() {
                  t[a].jcnah = !1
      ...
      v = function(e) {
          ...
          for (var r in t)
              ...
              } return i.noInt && (i.controls = !1), void 0 !== e.mp4 && (i.mp4 = e.mp4), void 0 !== e.videomp4 && (i.mp4 = e.videomp4), void 0 !== e.ytid && (i.ytid = e.ytid), void 0 !== e.ogv && (i.ogv = e.ogv), void 0 !== e.webm && (i.webm = e.webm), void 0 !== e.vimeoid && (i.vimeoid = e.vimeoid), void 0 !== e.vatr && (i.vatr = e.vatr), void 0 !== e.videoattributes && (i.vatr = e.videoattributes), void 0 !== e.poster && (i.poster = e.poster), void 0 !== e.bgvideo && (i.bgvideo = e.bgvideo), 1 === i.bgvideo && (i.volume = "mute"), i.ssec = a(i.start), i.esec = a(i.end), i.loopcache = i.loop, i.inColumn = e._incolumn, i
      },
      y = function(e, i) {
