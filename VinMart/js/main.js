(function ($) {
    ...
    $(window).scroll(function () {
        ...
        if (scroll >= 1) {
            sticky.addClass('fixedMenuTop');
            $('.wrapperMain').addClass('margintop83');
        } else {
            sticky.removeClass('fixedMenuTop');
            $('.wrapperMain').removeClass('margintop83');
        }
    });
    ...
    $('.openpopup').click(function () {
        var source2 = $(this).children('img').attr('src');
        $("#popupimage").attr("src", source2);
        //alert(source2);
    });
})(jQuery);