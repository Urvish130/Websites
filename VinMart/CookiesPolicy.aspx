<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CookiesPolicy.aspx.cs" Inherits="CookiesPolicy" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-title color" style="text-align: left">
                    <h3>Cookie Policy for thinktank - IoT</h3>
                    <p>This is the Cookie Policy for ThinkTank IOT, accessible from <a href="http://www.thinktank-iot.com">www.thinktank-iot.com</a></p>
                </div>
                <div class="space" style="height: 20px"></div>
                <div class="elementor-text-editor">
                    <h5 style="color:#007FCC">What Are Cookies</h5>
                    <p>
...
downgrade or 'break' certain elements of the sites functionality.
                    ...
                    <h5 style="color:#007FCC">How We Use Cookies</h5>
                    <p>
...
sure whether you need them or not in case they are used to provide a service that you use.
                    ...
                    <h5 style="color:#007FCC">Disabling Cookies</h5>
                    <p>
                        You can prevent the setting of cookies by adjusting the settings on your browser (see your
browser Help for how to do this). Be aware that disabling cookies will affect the functionality of
this and many other websites that you visit. Disabling cookies will usually result in also disabling
certain functionality and features of the this site. Therefore it is recommended that you do not
disable cookies.
                    </p>
                    <h5 style="color:#007FCC">The Cookies We Set</h5>
                    <ul>
...
interesting insights, helpful tools, or to understand our user base more accurately. These
surveys may use cookies to remember who has already taken part in a survey or to
...
interact with a page is affected by your preferences.
                    ...
                    <h5 style="color:#007FCC">Third Party Cookies</h5>
                    <p>
...
can improve your experience. These cookies may track things such as how long you
...
page.
                        ...
                        <li>Third party analytics are used to track and measure usage of this site so that we can
...
which optimisations our users appreciate the most.
                        ...
                        <li>As we sell products it's important for us to understand statistics about how many of the
visitors to our site actually make a purchase and as such this is the kind of data that these
cookies will track. This is important to you as it means that we can accurately make
business predictions that allow us to monitor our advertising and product costs to ensure
the best possible price.
                        </li>
                        <li>The Google AdSense service we use to serve advertising uses a DoubleClick cookie to
...
development. The behavioural advertising cookies used by this site are designed to
ensure that we provide you with the most relevant adverts where possible by
anonymously tracking your interests and presenting similar things that may be of interest.
                        </li>
                        <li>Several partners advertise on our behalf and affiliate tracking cookies simply allow us to
...
sites including; {List the social networks whose features you have integrated with your
site?:12}, will set cookies through our site which may be used to enhance your profile on
their site or contribute to the data they hold for various purposes outlined in their
respective privacy policies.
                        </li>
                    </ul>
                    <h5 style="color:#007FCC">More Information</h5>
                    <p>
...
preferred contact methods:
                    ...
                    <ul>
                        <li>Email:info@thinktank-iot.com</li>
                        <li>By visiting this link: <a href="http://www.thinktank-iot.com">www.thinktank-iot.com</a></li>
                        <li>Phone: +91 951 097 7518 </li>
                    </ul>
                </div>
            </div>
        </div>
